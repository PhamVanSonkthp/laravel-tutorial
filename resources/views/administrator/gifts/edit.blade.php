    ...
    <form action="{{route('administrator.gifts.update', ['id'=> $gift->id]) }}" method="post" enctype="multipart/form-data">
        ...
        <div class="col-md-6">
            ...
            <div class="form-group mt-3">
                ...
                <input type="text" name="contents_parent" class="form-control @error('contents_parent') is-invalid @enderror" placeholder="Nhập nội dung" value="{{$gift->content}}">
            ...
            <div class="container_sources mt-3">
                ...
                @foreach($gift->giftChildren as $giftChildItem)
                    <div class="row">
                        <div class="col-md-6 mt-1">
                            <div class="form-group">
                                <input name="contents[]" type="text"
                                       class="name form-control @error('contents') is-invalid @enderror"
                                       placeholder="Tên món quà" value="{{$giftChildItem->content}}">
                                @error('contents')
                                <div class="alert alert-danger">{{$message}}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-5 mt-1">
                            <div class="form-group">
                                <input name="probabilities[]" type="text"
                                       ...
                                       placeholder="Xác xuất %" value="{{$giftChildItem->probability}}">
                                @error('probabilities')
                                <div class="alert alert-danger">{{$message}}</div>
                                @enderror
                            </div>
